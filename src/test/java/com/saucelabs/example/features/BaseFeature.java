...
public abstract class BaseFeature
{
    ...
    /**
     * If you are using Sauce Connect Proxy to to test an application that is behind a
     * firewall or on your local machine, you must provide the identifier of the
     * Sauce Connect tunnel to use.
     */
    private static String tunnelId = System.getenv("SAUCE_TUNNEL_ID");

    /**
     * This desired capability will let the test job use any shared tunnels available
     * from the specified parent account. i.e. any account that is upstream in the
     * hierarchy. If using a shared tunnel, you must specify both tunnelIdentifier
     * and parentTunnel.
     */
    private static String parentTunnelUserName = System.getenv("SAUCE_PARENT_TUNNEL_USERNAME");
    ...
    {
        return new Object[][]{new Object[]{"Android", "9", "Google.*"}, new Object[]{"Android", "8.1.0", ".*"}, new Object[]{"Android", "8.1", "Android GoogleAPI Emulator"}, new Object[]{"Android", "8.0", "Android GoogleAPI Emulator"},
     ...
     * @param sauceOptions   Additional Sauce Labs-specific configuration items that will be used by the WebDriver instance.
     * @return
     * @throws MalformedURLException if an error occurs parsing the url
     */
    protected RemoteWebDriver createDesktopDriver(String browser, String browserVersion, String os, MutableCapabilities sauceOptions)
    {
        ...
        // Add additional values to the Sauce options...
        ...
        if (parentTunnelUserName != null)
        {
            sauceOptions.setCapability("parentTunnel", parentTunnelUserName);
        }

        /**
         * The following are optional settings that can be specified.
         * @see See the <a href="https://wiki.saucelabs.com/display/DOCS/Platform+Configurator#/">Platform Configurator</a> for more details.
         */

//        sauceOptions.setCapability("recordVideo", "true");
//        sauceOptions.setCapability("recordMp4", "true");
...
//        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
    ...
    protected static RemoteWebDriver createMobileDriver(String platformName, String platformVersion, String deviceName, String testName)
    {
        URL url = null;
